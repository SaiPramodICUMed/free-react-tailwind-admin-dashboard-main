...
const handleChange = (event: any) => {
  ...
  useEffect(() => {
    fetchAccountsCount(user.activeCountryId);
    fetchGroupsCount(user.activeCountryId);
  ...
  useEffect(() => {
    ...
    return (
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-4 md:gap-4">
            ...
            {/* <!-- Metric Item 1 --> */}
            <Link
                to="../segmentation" // 👈 Navigate to your desired route
            ...
            {/* <!-- Metric Item 2 --> */}
            <Link
                to="../segmentationGroup" // 👈 Navigate to your desired route
                className="block rounded-xl border border-gray-200 bg-white p-3 
             dark:border-gray-800 dark:bg-gray-900 hover:shadow-md hover:scale-[1.02]
             transition-all duration-200 text-gray-800 dark:text-gray-100"
            >
