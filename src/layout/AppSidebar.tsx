...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "Explorer", path: "/explorer", pro: false },
      { name: "SIA", path: "/sia", pro: false },
    ],
  },
  {
    name: "Strategy",
    ...
    subItems: [
      ...
      { name: "Approval Controls", path: "/approvalControls", pro: false },
      { name: "Competitors", path: "/competitors", pro: false },
